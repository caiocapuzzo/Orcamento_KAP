#ifndef ORCAMENTO_NOVO_H
#define ORCAMENTO_NOVO_H
...
namespace Ui {
class orcamento_novo;
}

class orcamento_novo : public QDialog
{
    Q_OBJECT

public:
    explicit orcamento_novo(SessaoUsuario sessao, QWidget *parent = nullptr);
    ~orcamento_novo();
...
private slots:
    ...
    void on_txt_codP_cursorPositionChanged(int arg1, int arg2);
    ...
    void on_cb_dll_currentTextChanged(const QString &arg1);
    void on_bt_desconto_geral_clicked();
    void on_bt_prazo_iguais_clicked();
    void on_tw_cliloja_cellClicked(int row, int column);
    ...
    void on_cb_frete_currentTextChanged(const QString &arg1);
    ...
    void on_txt_codP_img_semelhante_editingFinished();

private:
    Ui::orcamento_novo *ui;
